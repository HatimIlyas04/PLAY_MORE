                                ...
                                <table class="table all-package theme-table table-product" id="table_id">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-dark" >{{$categorie->deleted_at}}</td>

                                            <td>
                                                <ul>
                                                    <li>
                                                        <a href="{{route('admin.category.restore',$categorie->id)}}">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form id="formDeleteProduct{{ $categorie->id }}" 
                                                            action="{{ route('admin.category.hardDelete', $categorie->id) }}" method="POST">
                                                            @csrf
                                                            @method('delete')
