...
<form class="theme-form theme-form-2 mega-form" method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data"> 
    @csrf 
                                    ...
                                    <div class="card-header-2">
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            <label class="col-sm-3 col-form-label form-label-title">Product
                                                Description </label>
                                                <div class="col-sm-9">
                                                    <textarea name="description_article" id="description" class="form-control" rows="5"></textarea>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="number"  step="0.01" name="prix_article" placeholder="0" >
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    <label class="col-sm-3 form-label-title">taux remise</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="number"  step="0.01" name="taux_remise" placeholder="0" >
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    <label class="col-sm-3 form-label-title">taux tva</label>
                                    <div class="col-sm-5">
                                        <input class="form-control" type="number"  step="0.01" name="taux_tva" placeholder="0" >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <div id="tag-inputs">
                                            ...
                                            <div class="d-flex tag-row my-1">
                                                ...
                                                <button type="button" class="btn btn-danger remove-tag btn-sm">
                                                    <b><i class="ri-delete-bin-line"></i></b></button>                                            </div>
                                        
                                    </div>  
                                    <center><button type="button" class="btn btn-success add-tag mt-3">Add Tag</button></center>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="theme-form theme-form-2 mega-form" id="options-container">
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="property_values[]" placeholder="Enter value" required>
                                                </div>
                                                <div class="col-sm-1 ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="theme-form theme-form-2 mega-form">
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text"  name='quantite_stock'>
                                            </div>
                                        </div>
                                        <div class="mb-4 row align-items-center">
