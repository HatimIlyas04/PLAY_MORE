                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="contact-image">
                                    <img src="../styleTest/images/inner-page/contact-us.png" class="img-fluid blur-up lazyloaded" alt="">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-xxl-6 col-lg-12 col-sm-6">
                                            <div class="contact-detail-box">
                                                ...
                                                <div class="contact-detail-contain">
                                                    <p>contact.playmore@gmail.com</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-6 col-lg-12 col-sm-6">
                                            <div class="contact-detail-box">
                                                ...
                                                <div class="contact-detail-title">
                                                    <h4>{{$boutique->libelle_boutique}}</h4>
                                                </div>

                                                <div class="contact-detail-contain">
                                                    <p>{{$boutique->adresse_boutique}}</p>
                                                    <p>{{$boutique->telephone_boutique}}</p>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-xxl-6 col-lg-12 col-sm-6">
                                <div class="mb-md-4 mb-3 custom-form">
                                    ...
                                    <div class="custom-input">
                                        <input type="text" class="form-control" id="exampleFormControlInput" name="prenom" placeholder="Enter First Name">
                            ...
                            <div class="col-xxl-6 col-lg-12 col-sm-6">
                                <div class="mb-md-4 mb-3 custom-form">
                                    ...
                                    <div class="custom-input">
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="nom" placeholder="Enter Last Name">
                                        <i class="fa-solid fa-user"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-lg-12 col-sm-6">
                                <div class="mb-md-4 mb-3 custom-form">
                                    ...
                                    <div class="custom-input">
                                        <input type="tel" class="form-control" id="exampleFormControlInput3" name="telephone" placeholder="Enter Your Phone Number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value =
